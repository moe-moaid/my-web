    ...
    <div className="flex flex-row justify-center gap-x-8 mt-8">
      ...
      >
        ...
        <input
          ...
          name="name"
          onChange={e => setCurrentValue({name: e.target.value, link: currentValue?.link})}
        />
        <input
          className="border-b border-[#2EC4CE] stroke-none outline-none w-full"
          type="text"
          placeholder="link"
          name="link"
          onChange={e => setCurrentValue({name: currentValue?.name, link: e.target.value})}
        />
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            setNewSocial([...newSocial, { name: currentValue?.name, link: currentValue?.link }]);
          }
          }
